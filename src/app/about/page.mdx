...
- **AI & Machine Learning:** Expertise in deploying LLMs and designing AI-driven workflows for sales and customer engagement.
- **Security & Scalability:** Implemented SOC 2-compliant encryption strategies and scalable infrastructure using Pulumi and AWS.
- **Design & User Experience:** Delivered pixel-perfect interfaces, blending design thinking with development skills.
